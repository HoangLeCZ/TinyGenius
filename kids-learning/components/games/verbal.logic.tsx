...
const BANK: {en:string, vi:string, answer:number}[] = [
  ...
  {en: `There are 2 chalkboards. Each chalkboard needs 2 pieces of chalk. How many pieces do you need?`, vi: `Có 2 cái bảng. Mỗi bảng cần 2 viên phấn. Bạn cần bao nhiêu viên phấn?`, answer: 4},
  ...
  {en: `There are 10 people. Each pizza has 4 slices. Each person gets 2 slices. How many pizzas should they order?`, vi: `Có 10 người. Mỗi pizza có 4 miếng. Mỗi người ăn 2 miếng. Cần đặt bao nhiêu pizza?`, answer: 5},

  // === TWO-STEP / MIXED ===
  {en: `Lana has 2 bags with 2 marbles in each bag. Markus has 2 bags with 3 marbles in each bag. How many more marbles does Markus have?`, vi: `Lana có 2 túi, mỗi túi 2 viên bi. Markus có 2 túi, mỗi túi 3 viên bi. Markus có nhiều hơn Lana bao nhiêu viên?`, answer: 2},
  {en: `There are 235 books in a library. On Monday, 123 books are taken out. On Tuesday, 56 books are brought back. How many books are there now?`, vi: `Thư viện có 235 quyển sách. Thứ Hai mượn đi 123 quyển. Thứ Ba trả lại 56 quyển. Bây giờ thư viện có bao nhiêu quyển?`, answer: 168},
  ...
  // === TIME / COUNTING ===
  {en: `There are 3 chalkboards. Each chalkboard has 2 pieces of chalk. If you take 1 piece from each board, how many are left?`, vi: `Có 3 cái bảng. Mỗi bảng có 2 viên phấn. Nếu lấy 1 viên ở mỗi bảng, còn lại bao nhiêu viên?`, answer: 3},
  {en: `It takes 3 cutlets to make a dish. You have 20 cutlets. How many dishes can you make?`, vi: `Làm 1 món ăn cần 3 miếng thịt. Bạn có 20 miếng. Bạn làm được bao nhiêu món?`, answer: 6},

  // === NUMBER SENSE ===
  {en: `I have a 7 in the tens place. I have an even number in the ones place. I am lower than 74. What number am I?`, vi: `Số của tôi có chữ số 7 ở hàng chục. Chữ số hàng đơn vị là số chẵn. Tôi nhỏ hơn 74. Tôi là số nào?`, answer: 72},
  {en: `What number is 6 tens and 10 ones?`, vi: `Số nào có 6 chục và 10 đơn vị?`, answer: 70},
]
